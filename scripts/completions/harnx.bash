_harnx() {
    ...
    case "${cmd}" in
        harnx)
            opts="-m -s -a -f -S -t -h -V --model --prompt --session --empty-session --save-session --agent --agent-variable --rag --rebuild-rag --macro --file --no-stream --dry-run --info --sync-models --list-models --list-sessions --list-agents --list-assistant-agents --list-rags --list-macros --tool --help --version"
