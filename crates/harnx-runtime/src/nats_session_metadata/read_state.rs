...
impl SessionReadState {
    ...
    /// Create a read state with cursor at given seq and no manual unread.
    pub fn read_at(seq: u64) -> Self {
        Self {
            last_attention_seq: seq,
            last_read_seq: seq,
            manual_unread: false,
        }
    }

    /// Create a manual unread state with given cursor.
    pub fn manual_unread_at(seq: u64) -> Self {
        Self {
            last_attention_seq: seq,
            last_read_seq: seq,
            manual_unread: true,
